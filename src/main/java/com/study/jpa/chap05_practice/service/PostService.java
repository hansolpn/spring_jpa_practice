...
import com.study.jpa.chap05_practice.repository.IHashTagRepository;
import com.study.jpa.chap05_practice.repository.IPostRepository;
...
public class PostService {
    ...
    public PostListResponseDTO getPosts(PageDTO dto) {
        ...
        // DB에서 조회한 정보를 JSON형태에 맞는 DTO로 변환 -> PostListResponseDTO
